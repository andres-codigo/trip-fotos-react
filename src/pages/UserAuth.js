		...
		<section className={userAuthStyles.userAuthenticationContainer}>
			...
			{/* <BaseCard>
				<form className={userAuthStyles.userAuthentication} onSubmit={submitForm}>
					<div
						className={`formControl ${!email.isValid ? 'invalid' : ''}`}>
					...
					<div
						className={`formControl ${!password.isValid ? 'invalid' : ''}`}>
			...
			{/* <BaseButton type="button" mode="flat" onClick={switchAuthMode}>
						{mode === APIConstants.API_AUTH_LOGIN_MODE ? 'Sign-up' : 'Login'}
					</BaseButton> */}
			{/* </form>
			</BaseCard> */}
		</section>
